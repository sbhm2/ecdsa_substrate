...
parameter_types! {
	...
	pub const BountyDepositPayoutDelay: BlockNumber = 10;
	pub const TreasuryModuleId: ModuleId = ModuleId(*b"py/trsry");
	pub const BountyUpdatePeriod: BlockNumber = 140;
...
/// Configure test offchain worker
pub type SignedPayload = generic::SignedPayload<Call, SignedExtra>;

impl offchain_parking::Trait for Runtime {
	/// AuthorityId
	type AuthorityId = offchain_parking::crypto::TestAuthId;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		//parking offchain worker
		MyOffchainParking: offchain_parking::{Module, Call, Storage, ValidateUnsigned},
	}
);
